...
export class Watch extends React.Component {
  ...
  async componentDidMount() {
    ...
    if(data_level.data.subscription.level <= level) {
      ...
      this.setState({vidURL: data.data.url, loading: false, thumbnail: data_level.data.thumbnail, permission: true, TL: FirstSearchResult, share_URL: "?video="+this.props.videoId});
    } else {
